...
func (x *SearchResponse) GetAge() int32 {
	if x != nil {
		return x.Age
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x36, 0x0a, 0x0e, 0x53,
	...
	0x61, 0x67, 0x65, 0x32, 0x4a, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x65, 0x72,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*SearchRequest)(nil),  // 3: service.SearchRequest
	(*SearchResponse)(nil), // 4: service.SearchResponse
}
var file_user_proto_depIdxs = []int32{
	1, // 0: service.PersonInfo.info:type_name -> service.Person
	3, // 1: service.SearchService.Search:input_type -> service.SearchRequest
	4, // 2: service.SearchService.Search:output_type -> service.SearchResponse
